...
<html lang="pt-br">
  ...
  <body>
    <div class="container">
      <h1 class="jumbotron">Filtrar Alunos</h1>
      <div class="row">
      ...
      ?>
      <form name="filtalunos" action="" method="post">
        <div class="form-group">
          <input type="text" name="txtpesq" placeholder="Pesquisa" class="form-control">
        </div>
        <div class="radio">
          <label><input type="radio" name="rdfiltro" value="idaluno">Código</label>
        </div>
        <div class="radio">
        ...
        <div class="radio">
          <label><input type="radio" name="rdfiltro" value="categoria">Categoria</label>
        </div>
        <div class="form-group">
      ...
      if(isset($_SESSION["alunos"])){
        ...
        $aluno = unserialize($_SESSION["alunos"]);
        if(count($aluno) != 0 ){
      ?>
      ...
      <?php
          ...
          echo "Não há aluno relacionados!";
        }
      ...
      if(isset($_POST["filtrar"])){
        if(isset($_POST["rdfiltro"])){
          ...
          $_SESSION['alunos'] = serialize($array);
          header("location:filtrar-aluno.php");
